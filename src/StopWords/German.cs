// German stop words from spacy: https://github.com/explosion/spaCy/blob/master/spacy/lang/de/stop_words.py
...
zurück zusammen zwanzig zwar zwei zweite zweiten zweiter zweites zwischen".Split(new char[] { ' ', '\n', '\r', '\t' }, StringSplitOptions.RemoveEmptyEntries),
            StringComparer.OrdinalIgnoreCase
        );

        static German()
        {
            // German contractions (not as common as in English/French, but some exist)
            var contractions = new[] { "'s", "'n", "'m", "'t" };
